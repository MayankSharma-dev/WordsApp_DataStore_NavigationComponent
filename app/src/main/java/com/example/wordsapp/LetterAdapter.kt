...
class LetterAdapter(val listener:CustomOnClick) :
    ...
    class LetterViewHolder(val view: View, listener: CustomOnClick) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LetterViewHolder {
        ...
        return LetterViewHolder(layout,listener)
    }
